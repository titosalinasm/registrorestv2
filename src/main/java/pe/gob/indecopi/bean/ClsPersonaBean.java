...
public class ClsPersonaBean implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5318881715661941988L;
	...
	private Integer nuFlagMype;
	private List<ClsRepresentanteBean> lstRepresentante ;
	private Integer nuFlagSolicitante;
	
    public ClsPersonaBean() {
    	this.setLstRepresentante(new ArrayList<ClsRepresentanteBean>());
    }
	...
	public Integer getNuFlagMype() {
		return nuFlagMype;
	}

	public void setNuFlagMype(Integer nuFlagMype) {
		this.nuFlagMype = nuFlagMype;
	}

	public List<ClsRepresentanteBean> getLstRepresentante() {
		return lstRepresentante;
	}

	public void setLstRepresentante(List<ClsRepresentanteBean> lstRepresentante) {
